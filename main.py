...
def play_music():
    ...
    for i in range(len(conditions)):
        ...
        if calming_description == "":
            calming_description = "Calming music"
        if focus_description == "":
            focus_description = "Deep Focus music"
        
        calming_description = calming_description + conditions[i]["calming"]
        focus_description = focus_description + conditions[i]["focus"]
